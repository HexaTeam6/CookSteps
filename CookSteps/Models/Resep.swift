...
extension Resep{
    static var sampleData = [
        ...
        Resep(judulResep: "Mie Goreng Bakso", bahan: ["Mie", "Bakso", "Telur", "Bawang"], alat: ["Penggorengan", "Pisau", "Spatula"], instruksi: ["Memanaskan minyak", "Tumis bumbu", "Memasak telur", "Memasak ayam", "Memasak nasi"]),
